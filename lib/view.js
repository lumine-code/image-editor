    ...
    try {
      ...
      fileOps.saveImage(
        ...
        (path, stats) => {
          ...
          // revision being shown now. Without it the record goes on naming the
          // revision from before the edit, and a later restore of that file
          // would be waved through as already displayed.
          this.noteShownFile(path, stats);
          this.isSaving = false;
